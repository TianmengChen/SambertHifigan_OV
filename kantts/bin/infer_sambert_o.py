...
def am_synthesis(symbol_seq, fsnet, ling_unit, device, se=None):
    ...
    # print(inputs_ling.shape,inputs_emo.shape,inputs_spk.shape,inputs_len)
    ...
    print("-------------Sambert torch model infer for short sentence costs time: %f ms-------------"%(time.time()* 1000 - start))
