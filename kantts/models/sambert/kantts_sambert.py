...
class KanTtsSAMBERT(nn.Module):
    ...
    def forward(
        ...
        return res
        # return x_band_width,h_band_width,dec_outputs,postnet_outputs,LR_length_rounded,log_duration_predictions,pitch_predictions,energy_predictions


class KanTtsSAMBERTHalfOV(nn.Module):
    def __init__(self, config):
        super(KanTtsSAMBERTHalfOV, self).__init__()
    ...
    def forward(
        ...
        return text_hid, emo_hid, spk_hid, inter_masks
    

class KanTtsSAMBERTHalfWithoutOV(nn.Module):
    def __init__(self, config):
        super(KanTtsSAMBERTHalfWithoutOV, self).__init__()
